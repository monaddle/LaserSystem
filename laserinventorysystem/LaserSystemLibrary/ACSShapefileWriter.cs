...
namespace LaserSystemLibrary
{
    public class ACSShapefileWriter
    {
        ...
        public ACSShapefileWriter(string path)
        {
            ...
            fs.DataTable.Columns.Add("REDEDGE", typeof(double));
            fs.DataTable.Columns.Add("NIR", typeof(double));
            fs.DataTable.Columns.Add("RED", typeof(double));
            fs.DataTable.Columns.Add("NDRE", typeof(double));
            fs.DataTable.Columns.Add("NDVI", typeof(double));
        ...
        public void write(double x, double y, double z, double rededge, double nir, double red, double ndre, double ndvi, string timestamp)
        {
            xy[0] = x;
            xy[1] = y;
            ...
            feature.DataRow["REDEDGE"] = rededge;
            feature.DataRow["NIR"] = nir;
            feature.DataRow["RED"] = red;
            feature.DataRow["NDRE"] = ndre;
            feature.DataRow["NDVI"] = ndvi;
